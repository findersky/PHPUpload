...
<title>PHP多图片上传程序</title>
<meta name="keywords" content="flash上传,免费flash上传,图片上传，免费图片上传，大容量图片上传，图片无刷新上传,图片,批量上传,学习交流论坛" />
	...
	<div id="cmain">
		<div id="uploadform">
			<form id="form1" action="#" method="post" enctype="multipart/form-data">
				<div>
					<a href="#" target="_blank"><img src="images/logo.png" style="height:60px;width:320px;border:none;" alt=""/></a>
				</div>
				<div class="button">
